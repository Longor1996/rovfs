...
pub trait Filesystem: std::fmt::Debug {
    ...
    fn read_blob(&self, id: file::FileId, ext: fext::FileExtCow<'_>) -> BoxFuture<Result<reader::ReadBlobObj>>;
    
    /// Returns a [`reader::ReadListObj`] that can resolve into the entries of the given directory.
    fn read_list(&self, id: file::FileId) -> BoxFuture<Result<reader::ReadListObj>>;
    
    /// Returns the parent of the given [`file::FileId`], if possible.
    fn parent(&self, id: file::FileId) -> BoxFuture<Result<file::FileId>>;
    
    /// Returns `true` if the given path (might be a file OR a directory!) exists.
    fn exists(&self, id: file::FileId) -> BoxFuture<bool>;
    
    /// Returns `true` if the given path exists and is a file.
    fn is_file(&self, id: file::FileId) -> BoxFuture<bool>;
    
    /// Returns `true` if the given path exists and is a directory.
    fn is_dir(&self, id: file::FileId) -> BoxFuture<bool>;
    ...
    fn watch(&self, id: file::FileId) -> Result<channel::Receiver<file::FileId>>;
